...
**WAJIB!!!** agar computer_use berfungsi di android, replace file yang ada di ~/debz_ai dengan file fixed didalam folder **PATCH FOR ANDROID**, karena file bawaan tested di alpine pathnya jelas berbeda dengan termux, dan playwright-core tidak support android, maka file fixed menggunakan CDN Chrome. Pastikan sudah install nginx dan php-fpm di termux!.
